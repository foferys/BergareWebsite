...
<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
    <div class="container px-4 px-lg-5">
        <img onclick="window.location.href ='index.php'" style="width: 30px;" src="./assets/img/logoBergare.png" alt="logo bergarè"> &nbsp;&nbsp;

        <a class="navbar-brand text-black" href="index.php">Bergaré</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto my-2 my-lg-0">
                ...
                <li class="nav-item"><a class="nav-link text-black" href="galleria.php">Galleria</a></li>
